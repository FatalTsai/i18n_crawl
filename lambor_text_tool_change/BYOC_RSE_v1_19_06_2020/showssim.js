...
const oUs = require('./en_US.json'); //origin 
...
function recursiveJsonParser(obj) {
  ...
  Object.keys(obj).forEach((key)=>{
      ...
      if(match)
      {
        ...
        res += `${key} |${matchlist[0].key}  match rate ${matchlist[0].rate}\n`
        res += '   '+obj[key]+'\n'
        res += '   '+matchlist[0].text+'\n'
        

       // console.log(`${key} match rate ${mat
...
console.log(res)
//res = flatten(oUs)
fs.writeFileSync('./showrate.txt',String(res))
